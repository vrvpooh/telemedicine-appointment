...
- **Safety:** ทดสอบ Transaction Rollback เมื่อเกิดข้อผิดพลาด( Error ตั้งแต่ขั้นตอนแรกๆ ซึ่งเป็นการเช็คว่า "ระบบจัดการ Error ได้)
...
- **Validation:** ตรวจสอบรูปแบบวันที่/เวลา และตรรกะเวลา (เวลาเริ่มต้องก่อนเวลาจบ)
